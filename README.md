...
Dentro de la carpeta zeek script encontramos los scripts personalizados de zeek (Los ficheros log de salida aportan el campo ts en formato UTC):
  ...
  * enrich_info.zeek aporta en los primeros 5 segundos de las conexiones información sobre estas relativas a nombres de dominio DNs, nombres de servidores SSl y certificados x509 empleados -> archivo enrich_conn.log
  *end_conn.zeek -> aporta los mismos datos que encontramos en el fichero conn.log pero el campo ts tiene formato UTC y no epochTime -> archivo End_Conn.log
